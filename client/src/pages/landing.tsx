...
const featuredOpportunities = [
  {
    ...
    description: "Experience full-stack development, participate in agile sprints, and learn modern programming practices.",
  },
  {
    id: 2,
    ...
    duration: "1 week",
    location: "Austin, TX",
    description: "Learn social media strategy, content creation, and campaign analytics in a fast-paced agency environment.",
  },
  {
    id: 3,
    ...
    duration: "2 weeks",
    location: "Denver, CO",
    description: "Shadow experienced PTs, observe patient treatments, and learn about rehabilitation techniques.",
  },
];
